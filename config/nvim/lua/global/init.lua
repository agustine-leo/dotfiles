...
-- Set the diagnostic popup to open on cursor hold
vim.o.updatetime = 10
vim.api.nvim_create_autocmd({ "CursorHold", "CursorHoldI" }, {
	group = vim.api.nvim_create_augroup("float_diagnostic", { clear = true }),
	callback = function()
		vim.diagnostic.open_float(nil, { max_width = 150, focus = false, scope = "cursor" })
	end,
})
...
-- [[ Buffer Switching ]]
--  See `:help buffer` for more information
